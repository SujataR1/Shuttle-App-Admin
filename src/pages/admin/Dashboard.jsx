      ...
      <div className={`flex-1 flex flex-col overflow-hidden transition-all duration-300 ${!isMobile ? 'lg:ml-72' : ''}`}>
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-6 md:space-y-8">
            ...
            {/* Trip Status Cards - Responsive Grid */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.3, delay: 0.05 }}
            ...
            >
              {[
                ...
                <div key={idx} className="bg-white rounded-xl p-3 sm:p-4 shadow-sm border border-gray-100 hover:shadow-md transition-all">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-xs text-gray-400">{stat.label}</p>
                      <p className="text-xl sm:text-2xl font-bold text-gray-800">{stat.value}</p>
                    </div>
                    <div className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-${stat.color}-100 flex items-center justify-center text-lg sm:text-xl`}>
                      {stat.icon}
                    </div>
                  </div>
                </div>
            ...
            {/* Booking Trends Section - Responsive */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.3, delay: 0.1 }}
            ...
            >
              <div className="flex justify-between items-center mb-4 sm:mb-6">
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-gray-800">Booking Trends</h3>
                  <p className="text-xs text-gray-500">Last 7 days</p>
                </div>
            ...
            >
              <div className="flex justify-between items-center mb-4 sm:mb-6">
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-gray-800">Top Pickup Stops</h3>
                  <p className="text-xs text-gray-500">Most popular locations</p>
                </div>
                  ...
                  return (
                    <div key={stop.stop_id}>
                      <div className="flex justify-between text-xs sm:text-sm mb-1">
                        <div className="flex items-center gap-2">
                          <span className="text-xs font-bold text-gray-400">#{index + 1}</span>
                          <span className="text-gray-700 font-medium truncate max-w-[150px] sm:max-w-none">{stop.stop_name}</span>
                        </div>
                        <span className="text-gray-800 font-semibold text-xs sm:text-sm">{stop.booking_count} bookings</span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                        <motion.div
                          initial={{ width: 0 }}
            ...
            >
              <div className="flex justify-between items-center mb-4 sm:mb-6">
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-gray-800">Most Booked Routes</h3>
                  <p className="text-xs text-gray-500">Popular journey patterns</p>
                </div>
                  ...
                  return (
                    <div key={route.route_id}>
                      <div className="flex justify-between text-xs sm:text-sm mb-1">
                        <div className="flex items-center gap-2">
                          <span className="text-xs font-bold text-gray-400">#{index + 1}</span>
                          <span className="text-gray-700 font-medium truncate max-w-[150px] sm:max-w-none">{route.route_name}</span>
                        </div>
                        <span className="text-gray-800 font-semibold text-xs sm:text-sm">{route.total_bookings} bookings</span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
                        <motion.div
                          initial={{ width: 0 }}
            ...
            {/* Two Column Layout for Recent Activity - Responsive */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                      ...
                      <div key={idx} className="p-3 sm:p-4 hover:bg-gray-50 transition-colors">
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                          ...
                          <div className="flex sm:flex-col justify-between sm:justify-start items-center sm:items-end gap-2 sm:gap-1">
                            <p className="font-semibold text-green-600 text-sm sm:text-base">₹{booking.amount}</p>
                            <span className={`text-xs px-2 py-0.5 rounded-full ${
                              booking.status === "booked" ? "bg-green-100 text-green-700" :
                              booking.status === "pending" ? "bg-yellow-100 text-yellow-700" :
                              "bg-red-100 text-red-700"
              ...
              >
                <div className="p-4 sm:p-6 border-b border-gray-100">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-gray-800">Recent Drivers</h3>
                      <p className="text-xs text-gray-500">Latest 5 registered drivers</p>
                    </div>
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-500 truncate max-w-[150px] sm:max-w-none">{driver.email}</p>
                              <p className="text-xs text-gray-400">{driver.phone}</p>
                            </div>
                          </div>
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.3, delay: 0.35 }}
              className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg"
            >
              <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left">
                <div>
                  <h3 className="text-lg sm:text-xl font-semibold text-white">Need to take action?</h3>
