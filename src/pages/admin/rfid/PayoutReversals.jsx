// // src/pages/admin/rfid/PayoutReversals.jsx
...
//     setSelectedTransferInfo(`Transfer: ${transfer.id?.slice(0, 8)}... • Amount: ${formatCurrency(transfer.amount)}`);
...
//                     Track and monitor provider-side payout reversals
//                   </p>
//                 </div>
...
//                                       Amount: {formatCurrency(transfer.amount)} • Status: {transfer.status}
//                                     </div>
//                                   </div>
//                                 ))
//                               )}
...
//                                       <div className="text-xs text-gray-500 mt-1">
//                                         {ride.amount && `Amount: ${formatCurrency(ride.amount)}`}
//                                       </div>
//                                     </div>
//                                   );
//                                 })
...
//                       <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Transfer ID</th>
//                       <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Ride ID</th>
...
//                       <tr>
//                         <td colSpan="8" className="px-6 py-12 text-center">
//                           <ArrowPathIcon className="w-16 h-16 text-gray-300 mx-auto mb-3" />
...
//                             <p className="font-bold text-gray-900">{formatCurrency(reversal.amount)}</p>
//                           </td>
...
//                           </td>
//                           <td className="px-6 py-4">
//                             <p className="text-sm font-mono text-gray-700">{reversal.driver_user_id?.slice(0, 12)}...</p>
//                           </td>
//                           <td className="px-6 py-4">
//                             <p className="text-sm text-gray-600 max-w-xs truncate">{reversal.reason || '-'}</p>
//                           </td>
//                           <td className="px-6 py-4">
...
const PayoutReversals = () => {
  ...
  const handleTransferSelect = (transfer) => {
    setFilters(prev => ({ ...prev, rfid_payout_transfer_id: transfer.id, page: 1 }));
    // UPDATED: Use driver_payout_amount instead of amount
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-xl overflow-hidden">
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gradient-to-r from-gray-50 to-gray-100">
                    <tr>                      <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                        Reversal Amount
