            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 sm:p-5 border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl sm:text-3xl font-bold text-emerald-600 mt-1">{users.filter(u => u.is_active).length}</p>
                </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 sm:p-5 border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl sm:text-3xl font-bold text-sky-600 mt-1">{users.reduce((sum, u) => sum + u.total_trips_booked, 0)}</p>
                </div>
                  ...
                  {userTransactions ? (
                    <>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
                        ...
                        <div className="bg-gradient-to-br from-emerald-50 to-white rounded-xl p-4 sm:p-5 border border-emerald-100 shadow-sm">
                          <p className="text-xs sm:text-sm text-emerald-600 font-medium">Total Earned</p>
                          <p className="text-xl sm:text-3xl font-bold text-emerald-700 mt-1">{formatCurrency(userTransactions.summary?.total_earned || 0)}</p>
                        </div>
                      </div>
