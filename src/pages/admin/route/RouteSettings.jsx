...
//             setAddressSuggestions([]);  // Clear suggestions when query is too short
//             return;
//         }
...
//     // Add this useEffect to clear suggestions when input is empty
//     useEffect(() => {
...
//                             fare.pickup_stop_id === sortedStops[i].stop_id &&
//                             fare.dropoff_stop_id === sortedStops[j].stop_id
//                         );
...
//                                 from: sortedStops[i].stop_name,
//                                 to: sortedStops[j].stop_name,
//                                 amount: existingFare.amount || 0,
//                                 is_active: existingFare.is_active !== undefined ? existingFare.is_active : true,
//                             });
//                         } else {
//                             generatedFares.push({
//                                 pickup_stop_id: sortedStops[i].stop_id,
//                                 dropoff_stop_id: sortedStops[j].stop_id,
//                                 from: sortedStops[i].stop_name,
//                                 to: sortedStops[j].stop_name,
//                                 amount: 0,
//                                 is_active: true,
...
//     return (
//         <div className="flex h-screen bg-gradient-to-br from-gray-50 to-gray-100">
//             <div className="w-64 bg-white shadow-xl fixed h-full z-10">
//                 <Sidebar />
//             </div>
...
//                                 <div className="w-10 h-10 flex items-center justify-center rounded-full bg-gradient-to-r from-gray-700 to-gray-600 text-white font-bold shadow-md">1</div>
//                                 <div>
//                                     <p className="text-sm font-semibold text-gray-700">Add Stops</p>
//                                     <p className="text-xs text-gray-400">Manual or JSON upload</p>
//                                 </div>
//                             </div>
//                             <div className="flex-1 h-[2px] bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 mx-6"></div>
//                             <div className="flex items-center gap-4">
//                                 <div className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-200 text-gray-600 font-bold">2</div>
//                                 <div>
//                                     <p className="text-sm font-semibold text-gray-700">Create Route</p>
//                                     <p className="text-xs text-gray-400">Name & code</p>
//                                 </div>
//                             </div>
//                             <div className="flex-1 h-[2px] bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 mx-6"></div>
//                             <div className="flex items-center gap-4">
//                                 <div className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-200 text-gray-600 font-bold">3</div>
//                                 <div>
//                                     <p className="text-sm font-semibold text-gray-700">Assign Stops</p>
//                                     <p className="text-xs text-gray-400">Map stops to route</p>
//                                 </div>
//                             </div>
//                         </div>
//                     </div>
...
//                                     if (!value.trim()) {
//                                         setAddressSuggestions([]);  // Immediately clear suggestions when input becomes empty
//                                     }
//                                 }}
...
//             {fareModal && (
//                 <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 animate-fadeIn">
//                     <div className="bg-white rounded-2xl w-[95%] max-w-4xl max-h-[85vh] overflow-y-auto shadow-2xl">
//                         <div className="sticky top-0 bg-white border-b border-gray-100 px-6 py-4 flex justify-between items-center">
//                             <h3 className="text-xl font-bold text-gray-800">Manage Fares</h3>
//                             <button onClick={() => setFareModal(false)} className="text-gray-400 hover:text-gray-600 transition-all text-2xl w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-100">✕</button>
//                         </div>
//                         <div className="p-6">
//                             {fareData.length === 0 ? (
//                                 <div className="text-center py-12">
//                                     <p className="text-gray-500 mb-2">No fares configured for this route yet.</p>
...
//                                                         <td className="py-3 px-3 text-gray-700">{f.from}</td>
...
//                                                                     setFareData(updated);
//                                                                 }}
//                                                                 className="border border-gray-200 px-3 py-1.5 rounded-xl w-28 focus:ring-2 focus:ring-gray-200 focus:border-gray-400 outline-none"
//                                                                 min="0"
//                                                                 step="0.01"
//                                                             />
//                                                         </td>
...
//                                         <button onClick={() => setFareModal(false)} className="px-5 py-2 border border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 transition-all font-medium">Cancel</button>
//                                         <button onClick={handleManageFare} className="px-5 py-2 bg-gradient-to-r from-amber-600 to-yellow-600 text-white rounded-xl hover:from-amber-700 hover:to-yellow-700 transition-all font-medium shadow-md hover:shadow-lg">Save Fares</button>
//                                     </div>
//                                 </>
//                             )}
//                         </div>
                                        ...
                                        return (
                                            <tr 
                                                ...
                                                className={`border-b border-gray-50 hover:bg-gray-50 transition-all ${
                                                    f.is_full_route ? 'bg-purple-50/30' : 
                                            ...
                                            >
                                                ...
                                                <td className="py-3 px-3">
                                                    <span className={`inline-flex items-center px-2 py-1 rounded-md text-xs font-medium ${
                                                        totalMinutes > 0 ? "bg-blue-100 text-blue-700" : "bg-gray-100 text-gray-600"
                                                    }`}>
                                                        {timeDisplay}
                                                    </span>
                                                </td>
                                                <td className="py-3 px-3">
                                                    <input
                                                        ...
                                                        className={`border px-3 py-1.5 rounded-xl w-28 focus:ring-2 focus:ring-gray-200 focus:border-gray-400 outline-none ${
                                                            f.amount === 0 ? 'border-red-300 bg-red-50' : 'border-gray-200'
                                                        }`}
                                                        min="0"
                                                        step="0.01"
                                                    />
